		...
		function bindSelectSearch()
		{
			$(".switchable_nav li:last").unbind('click').bind('click',function(){
				var li_html1 = $(".switchable_nav li:last");
		 		...
		 		$(".switchable_nav li:last").hide();
		 		list_type = ($(".switchable_nav li:first").find("a").text() == "公司")?1:2;
...
<div class="toolbar">
				...
				<div class="search_con">
					<form method="post" action="<?=base_url()?>search/index">
						<div class="search_triggers search_triggers_hover">
							<input type="hidden" name="type" id="list_type" value="<?=isset($list_type)?($list_type):1?>">
						...
						<div class="search_panel_fields">
							<div class="search_combobox"><label class="ico search_label"></label><input class="input_txt" style="padding-left:20px" type="text" name="key_word"/></div>
						</div>
	...
	<div class="mainNav">
		<div class="mainNavWrap">
			<!-- 全部商品分类 -->
			<?$this->load->view('layout/category')?>
			<!-- 全部商品分类 end -->
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
	<head>
		...
		<link rel="shortcut icon" href="<?=base_url()?>webroot/images/favicon.ico" />
