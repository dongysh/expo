...
<div class="wrap">
	<div class="content register_wrap">
		...
		<div class="colmain">
			...
			<div class="col_bd">
				<h3>完善您的账户信息<span class="remark">（带<b class="star">*</b>字为必填项）</span></h3>
				<div class="filed"><label class="keyName"><b class="star">*</b>Emali：</label>
					<input class="input_txt" id = "login_name" type="text" <? if(isset($user['email']) && !empty($user['email'])):?>readonly<?endif;?> name="login_name" value="<?if(isset($user['email']) && !empty($user['email'])) echo $user['email']; ?>" />
			...
			<div class="col_bd">
				...
				<div class="filed"><label class="keyName"><b class="star">*</b>Name：</label>
					<input class="input_txt" id="first_name"type="text" name="first_name" value="<?=$user['name']?>" />
					<div class="join_input_error">
                        <span id="name_error" class="error"></span>
                    </div>					
				</div>
				<div class="filed">
					<label class="keyName"><b class="star">*</b>Gender：</label>
					<label class="sel_label">
						<input name="sex" class="input_radio" type="radio" <?if(isset($_SESSION['oauth_user']['gender']) && ($_SESSION['oauth_user']['gender'] == 'male' )):?>checked<?endif;?> value="1"/>Male</label>
					<label class="sel_label">
						<input name="sex" class="input_radio" type="radio" <?if(isset($_SESSION['oauth_user']['gender']) && ($_SESSION['oauth_user']['gender'] == 'famale' )):?>checked<?endif;?> value="0"/>Female</label>
                ...
                <input type="hidden" name="validate_user" value="<?if(isset($user['email']) && !empty($user['email'])):?>1<?else:?>0<?endif;?>">
